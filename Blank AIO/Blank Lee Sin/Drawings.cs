        ...
        public static void OnDraw(EventArgs args)
        {
            ...
            if (Misc.GetMenuItem("Draw.Insec.Lines"))
                if (newTarget != null && newTarget.IsVisible && newTarget.IsValidTarget() && !newTarget.IsDead
                    && EnsoulSharp.Common.Geometry.Distance(ObjectManager.Player, newTarget) < 3000)
                {
            ...
            if (!Misc.GetMenuItem("DrawEnabled")) return;
            ...
            {
                Render.Circle.DrawCircle(EnsoulSharp.Common.Geometry.To3D(Wardmanager.JumpPos), 20, Color.Red);
