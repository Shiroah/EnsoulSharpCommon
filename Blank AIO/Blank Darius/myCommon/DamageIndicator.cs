...
namespace myCommon
{
    public static class DamageIndicator // Credit By Detuks
    {
        ...
        private static readonly Render.Text Text = new Render.Text(0, 0, "", 11, new ColorBGRA(255, 0, 0, 255),
            "monospace");
        ...
        public static DamageToUnitDelegate DamageToUnit
        {
            set
            {
                if (_damageToUnit == null) Drawing.OnDraw += Drawing_OnDraw;
        ...
        {
            if (!Enabled || _damageToUnit == null) return;
