    ...
    public static class Menus
    {
        ...
        public static void Initializer()
        {
            Config = new Menu("hCamille", "hCamille", true);
            {
                ...
                {
                    combomenu.AddItem(
                        new MenuItem("q.settings", "[Q] Settings").SetFontStyle(
                            FontStyle.Bold,
                            Color.Gold));
                    combomenu.AddItem(new MenuItem("q.combo", "Use [Q]").SetValue(true));
                    combomenu.AddItem(
                        new MenuItem("q.mode", "[Q] Type").SetValue(
                            new StringList(new[] { "After Attack", "In AA Range" })));

                    combomenu.AddItem(
                        new MenuItem("W.settings", "[W] Settings").SetFontStyle(
                            FontStyle.Bold,
                            Color.Gold));
                    combomenu.AddItem(new MenuItem("w.combo", "Use [W]").SetValue(true));
                    combomenu.AddItem(
                        new MenuItem("w.mode", " [W Mode]").SetValue(new StringList(new[] { "While Dashing", "Always" },
                            1)));

                    combomenu.AddItem(
                        new MenuItem("E.settings", "[E] Settings").SetFontStyle(
                            FontStyle.Bold,
                            Color.HotPink));
                    combomenu.AddItem(new MenuItem("e.combo", "Use [E]").SetValue(true));
                    combomenu.AddItem(
                        new MenuItem("wall.search.range", "[E] Wall Search Range").SetValue(new Slider(1300, 1,
                            2500)));
                    combomenu.AddItem(
                        new MenuItem("wall.distance.to.enemy", "[E] Max Wall Distance to Enemy").SetValue(
                            new Slider(865, 1, 1500)));
                    combomenu.AddItem(
                        new MenuItem("enemy.search.range", "[E] Enemy Search Range").SetValue(new Slider(1365, 1365,
                            1900)));
                    combomenu.AddItem(
                        new MenuItem("max.enemy.count", "[E] Max Enemy Count").SetValue(new Slider(5, 1, 5)));
                ...
                var ultimatemenu = new Menu("Ultimate Settings", "Ultimate Settings");
                {
                    ...
                    ultimatemenu.AddItem(
                        new MenuItem("enemy.health.percent", "[R] Enemy Health Percentage").SetValue(new Slider(30, 1,
                            99)));
                    ...
                    var whitelist = new Menu("Ultimate Whitelist", "Ultimate Whitelist");
                    {
                        foreach (var enemy in HeroManager.Enemies)
                            whitelist.AddItem(
                                new MenuItem("r." + enemy.CharacterName, "Use [R]:  " + enemy.CharacterName).SetValue(
                                    Utilities.HighChamps.Contains(enemy.CharacterName)));
                        ultimatemenu.AddSubMenu(whitelist);
                    }
                    ultimatemenu.AddItem(
                        new MenuItem("r.mode", "[R] Type").SetValue(new StringList(new[] { "Auto", "Only Selected" })));
                ...
                var harassmenu = new Menu("Harass Settings", "Harass Settings");
                {
                    ...
                    harassmenu.AddItem(new MenuItem("harass.mana", "Mana Manager").SetValue(new Slider(50, 1, 99)))
                ...
                var clearmenu = new Menu("Wave Settings", "Wave Settings");
                {
                    ...
                    clearmenu.AddItem(new MenuItem("clear.mana", "Mana Manager").SetValue(new Slider(50, 1, 99)))
                        .SetFontStyle(FontStyle.Bold, Color.Gold);
                ...
                var junglemenu = new Menu("Jungle Clear Settings", "Jungle Clear Settings");
                {
                    ...
                    junglemenu.AddItem(new MenuItem("jungle.mana", "Mana Manager").SetValue(new Slider(50, 1, 99)))
                        .SetFontStyle(FontStyle.Bold, Color.Gold);
                ...
                var drawMenu = new Menu("Draw Settings", "Draw Settings");
                {
                    ...
                    {
                        skillDraw.AddItem(
                            new MenuItem("q.draw", "Draw E Range").SetValue(new Circle(false,
                                System.Drawing.Color.White)));
                        skillDraw.AddItem(
                            new MenuItem("w.draw", "Draw W Range").SetValue(new Circle(false,
                                System.Drawing.Color.White)));
                        skillDraw.AddItem(
                            new MenuItem("e.draw", "Draw E Range").SetValue(new Circle(false,
                                System.Drawing.Color.White)));
                        skillDraw.AddItem(
                            new MenuItem("r.draw", "Draw R Range").SetValue(new Circle(false,
                                System.Drawing.Color.White)));
                ...
                var drawFill =
                    new MenuItem("RushDrawEDamageFill", "Combo Damage Fill").SetValue(new Circle(true,
        ...
        private static float TotalDamage(AIHeroClient hero)
        {
            ...
            if (Spells.Q.IsReady())
            {
                if (Calculation.HasProtocolOneBuff) damage += hero.ProtocolDamage();
                if (Calculation.HasProtocolTwoBuff) damage += hero.ProtocolTwoDamage();
            }

            if (Spells.W.IsReady()) damage += hero.TacticalDamage();
            if (Spells.E.IsReady()) damage += hero.WallDiveDamage();
            if (Spells.R.IsReady()) damage += hero.HextechDamage() * 4;
            return (float)damage;
        }
    }
}