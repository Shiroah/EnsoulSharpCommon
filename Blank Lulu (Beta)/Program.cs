...
namespace Blank_Lulu__Beta_
{
    class Program
    {
        ...
        static void ShootQ(bool useE = true)
        {
            ...
            AIBaseClient luluTarget = TargetSelector.GetTarget(Q.Range, TargetSelector.DamageType.Magical);
            ...
            if (target != null)
            {
                ...
                Q.From = source.Position;
                Q.RangeCheckFrom = source.Position;
        ...
        private static void Farm()
        {
            ...
            if (useE)
            {
                foreach (var minion in allMinions.Where(m => m.Name.EndsWith("MinionSiege") && E.IsKillable(m)))
                {
                    E.Cast(minion);
                }
            }
        ...
        static void JungleFarm()
        {
            ...
            var mobs = MinionManager.GetMinions(Player.Position, E.Range, MinionTypes.All,
        ...
        static void JungleKS()
        {
            ...
            if (mob != null && jungleMobNames.Contains(mob.Name.ToLowerInvariant()) && E.IsKillable(mob))
            {
                E.Cast(mob);
            }
        ...
        public static float GetComboDamage(AIHeroClient target)
        {
            ...
            if (IgniteSlot != SpellSlot.Unknown && Player.Spellbook.CanUseSpell(IgniteSlot) == SpellState.Ready)
                result += (float)ObjectManager.Player.GetSummonerSpellDamage(target, Damage.DamageSummonerSpell.Ignite);
